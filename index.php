            ...
            <ul class="topbar-nav nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-submenu">
                        ...
                        <a class="nav-link active" href="blog-grid.html">Layout grid</a>
            ...
            <div class="row gap-y">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card card-hover-shadow">
                        <a href="details.php?id=<?=$data['id'];?>"><img class="card-img-top" style="width: 349px; height: 300px;" src="img/<?= $data['img']; ?>" alt="Card image cap"></a>
